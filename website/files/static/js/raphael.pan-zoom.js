...
(function () {
    ...
    PanZoom = function (el, options) {
        ...
        container.onmousedown = function (e) {
            ...
            container.ontouchmove = dragging;
        ...
        function repaint() {
            ...
            if (settings.horizontalScroll && settings.verticalScroll)
              paper.setViewBox(me.currPos.x, me.currPos.y, newWidth, newHeight);             
            else if (settings.horizontalScroll)
              paper.setViewBox(me.currPos.x, paper.height/2 - newHeight/2, newWidth, newHeight);
            else if (settings.verticalScroll)
              paper.setViewBox(paper.width/2 - newWidth/2, me.currPos.y, newWidth, newHeight);
        }
    };
