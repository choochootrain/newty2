...
"""Settings to edit"""
"""If true, just prints stuff out and doesn't let you actually write to database"""
testing = True
...
def main():
    ...
    store_info = lambda queue_obj : sort_information(queue_obj, get_title, get_body,
                                            get_date, testing, success, failure, queue)
    map_incremental(store_info, file_queue)
